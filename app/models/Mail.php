...
class Mail{
  ...
  public static function send(User $user){
    ...
    $content  = 'Bonjour,'.$eol;
    $content .= 'Veuillez confirmer votre inscription sur le blog en cliquant sur ce lien : '.Configuration::BASE_URL.'controller=Authentication&action=validateAccount&token='.$user->getToken() .$eol;
